...
@section('title', 'Input Data Sikap')
                               ...
                               @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('nama_sikap') }}" class="@error('nama_sikap') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="nama_sikap" required="required" />
                                        @error('nama_sikap')
