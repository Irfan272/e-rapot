...
@section('title', 'Input Data Sub Mata Pelajaran')
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="/admin/sub_mata_pelajaran/store" method="post" novalidate>
                               @csrf
                                <span class="section">Input Data Sub Mata Pelajaran</span>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input value="{{ old('nama_submapel') }}" class="@error('nama_submapel') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="nama_submapel" required="required" />
                                        @error('nama_submapel')
