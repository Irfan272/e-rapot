            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="/admin/akunGuru/store" method="post" novalidate>
                               @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_guru" id="id_guru" class="form-control selectpicker" data-live-search="true"  required='required'>
                                            <option readonly value="">Pilih Guru (Nama, NIP)</option>
                                            @foreach ($guru as $s)
                                            <option value="{{ $s->id }}">{{ $s->nama_lengkap }}, {{ $s->NIP }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
