            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            @foreach ($setSikap as $sek)
                                
                            <form class="" action="/admin/nilai_sikap/update/{{ $sek->id }}" method="post" novalidate>
                               @csrf
                               @method('PATCH')
                                <span class="section">Edit Data Nilai Sikap</span>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_sikap" class="form-control"  required='required' data-validate-length-range="8,20">
                                            
                                            <option disabled value="">Pilih Sikap</option>
                                            @foreach ($sikap as $mp)
                                            <option @if ($sek->id_sikap == $mp->id)
                                                selected
                                            @endif value="{{ $mp->id }}">{{ $mp->nama_sikap }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="ln_solid">
                                    <div class="form-group">
                                        <div class="col-md-6 offset-md-3">
                                            ...
                                            <a href="/admin/nilai_sikap" class="btn btn-danger">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
