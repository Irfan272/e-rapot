...
@section('title', 'Input Nilai Muatan Lokal')
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="/admin/nilai_ml/store" method="post" novalidate>
                               @csrf
                                <span class="section">Input Nilai Muatan Lokal</span>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_mulok" id="id_mapel" class="form-control selectpicker" data-live-search="true"  required='required'>
                                            <option readonly value="">Pilih Mulok</option>
                                            @foreach ($mulok as $mp)
                                            <option value="{{ $mp->id }}">{{ $mp->nama_mulok }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_submulok" id="id_mapel" class="form-control selectpicker" data-live-search="true"  required='required'>
                                            <option readonly value="">Pilih Sub Mulok</option>
                                            @foreach ($submulok as $smp)
                                            <option value="{{ $smp->id }}">{{ $smp->nama_submulok }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
