            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="" action="/admin/nilai_mp/store" method="post" novalidate>
                               @csrf
                                <span class="section">Input Nilai Mata Pelajaran</span>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="id_submapels" id="id_mapel" class="form-control selectpicker" data-live-search="true"  required='required'>
                                            <option readonly value="">Pilih Sub Mapel</option>
                                            @foreach ($submapel as $smp)
                                            <option value="{{ $smp->id }}">{{ $smp->nama_submapel }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
